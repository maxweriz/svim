	...
	-- Copilot (vimscript); avoid <Tab> conflict with cmp
	{
		...
		init = function()
			...
			vim.keymap.set(
				...
				"<C-l>",
				'copilot#Accept("<CR>")',
				{ expr = true, silent = true, desc = "Copilot accept" }
			)
		end,
	},
}, {
...
do
	...
	vim.keymap.set("n", "<leader>se", function()
		M.show()
	end, { desc = "Show diagnostic hover box" })
	vim.keymap.set("n", "<leader>sE", function()
		M.hide()
	end, { desc = "Hide diagnostic hover box" })
end
...
map("n", "<leader>h", function()
	spawn_login_shell_split(false)
end, { desc = "Horizontal terminal (login shell)" })
map("n", "<leader>v", function()
	spawn_login_shell_split(true)
end, { desc = "Vertical terminal (login shell)" })
