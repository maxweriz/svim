-- Sonoran Daybreak — a warm desert-inspired colorscheme for Neovim
...
local p = {
	-- brighter sunrise accents, higher contrast text
	bg       = "#121113", -- deep pre-dawn
	bg_alt   = "#171517",
	surface  = "#1d1a1e",
	surface2 = "#242027",
	overlay  = "#2e2831",
	muted    = "#9e8f80",
	text     = "#ffe9c7", -- sunlit sandstone
	subtext  = "#ffd8a8",

	sun      = "#FFB703", -- golden sunrise
	burnt    = "#E76F51", -- canyon red/orange (color-hex Desert Sunrise)
	cactus   = "#2EC4B6", -- brighter cactus teal
	sky      = "#4895EF", -- vivid sky blue
	sage     = "#A7F0D1", -- brighter pale green
	purple   = "#9D4EDD", -- magenta twilight
	yellow   = "#FFD166", -- bright sand/yellow
	red      = "#F94144", -- punchier red
